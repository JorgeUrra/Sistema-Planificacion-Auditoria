...
if ($_POST["agregar"]) {
	...
	redirect('control/home_profesor');
			...
			<div class="section group">
				<div class="lsidebar span_4_of_3 services_list">
					<ul>
						...
						<li><a href="<?php echo site_url().'/control/home_profesor?array='.$atri['NOMBRE_A'].'&array2='.$atri['CODIGO_ASIGNATURA'];?>"><?php echo $atri['NOMBRE_A']?></a></li>
						<?php } ?> 
					</ul>
				</div>		
				<div class="lsidebar">
					...
					<div class="tab-content">
						<div class="tab-pane" id="planificacion">
							<div class="row">
								...
								<input onclick =" alert('Ingreso Correcto en la Base de Datos')" name="agregar" type="submit" value="Ingresar" class="btn btn-primary" onmouseover="hacer_hover()">                   
						...
						<div class="tab-pane" id="prueba">
							...
							<br>
							<button type="input" id="prueba" name="prueba" value="subir" class="btn btn-primary">Subir Prueba</button>
  						...
  						<div class="tab-pane" id="revision">
  							...
  							<button type="input" id="revision" name="revision" value="subir" class="btn btn-primary">Subir Revisión</button>
